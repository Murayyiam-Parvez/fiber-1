...
The "ext_list" file is generated by the picker. Each line specifies the information required to translate a binary signature. (eg. *examples/ext_list*)
...
2. [compiled unpatched kernel]: The compiled unpatched referenkernel. It is used for filtering signatures. (e.g., *examples/unpatchkernel*)

3. [compiled target kernel]: The compiled target kernel that needs to be tested. (e.g., *examples/imgs/targetkernel*)
